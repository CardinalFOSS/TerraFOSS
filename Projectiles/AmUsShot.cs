...
{
	public class AmUsShot : ModProjectile // amongus is subclass which has properties
	{                                    // modprojectile is class that amongus belongs to
		...
		public override void SetDefaults() // place stats here
		{
			...
			projectile.width = 50; // width of projectile that shows up (pixels?)
			projectile.height = 50; // height (pixels?)
			...
			drawOffsetX = -5; // offset sprite to match hitbox
			drawOriginOffsetY = -10; // offset sprite to match hitbox
