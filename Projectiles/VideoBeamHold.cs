...
{
	public class VideoBeamHold : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Video Beam Hold");
		...
		private void FireBeams()
		{
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<VideoBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = VideoCam.OverrideColor;
